...
function comercio_script()
{
    ...
    wp_register_script('archivo-js', get_bloginfo('template_directory') . '/assets/librerias/js/archivo.js', array('jquery'), '1', false);    
        
        /*encolamos los JS*/
        wp_enqueue_script('archivo-js', array('jquery'), true);
