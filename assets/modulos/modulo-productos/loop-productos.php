...
<section class="row d-flex text-center justify-content-between mt-5 mb-5 px-3">
    ...
    if (have_posts()) : while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
        ...
        <a class="tarjeta text-center p-1 m-1 text-dark col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" style="background-color:white;border-radius:5px">
